...
const alcoholsCtrl = {
    ...
    */
    async getAlcohol(req: any, res: any) {
        ...
        res.json({code: 200, message: 'get Alcohol', data: data});
    },
    ...
    */
    async getAlcohols(req: any, res: any) {
        ...
        res.json({code: 200, message: 'get Alcohols',data: data});
    },
    /** insert Alcohol 
    ...
    */
    async insertAlcohol(req: any, res: any) {        
        ...
        res.json({ code: 200, message: 'Alcohol inserted', data: {} });
    },
    /** delete Alcohol 
     * req : {alcoholId: string}
     * res : {code: number, message: string, data: {}}
    */
    async deleteAlcohol(req: any, res: any) {
        ...
        res.json({code: 200, message: 'Alcohol deleted', data: {}});
    },
    ...
    */
    async updateAlcoholLike(req: any, res: any) {
        ...
        res.json({ code: 200, message: 'Alcohol updated', data: {likes: data+likes} });
    }
}
